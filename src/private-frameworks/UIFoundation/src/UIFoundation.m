...
const uint8_t UIMaximumCompatibleFormatVersion = 1;
const uint8_t UICurrentCoderVersion = 10;
...
{
    char *headerIdentifier = (char *)[[data subdataWithRange: NSMakeRange(0, 10)] bytes];
